...
* **tflint:** 🐛 bump Azure rules version, fix signature bug e7ea0c6

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu ad31a33
* **deps:** update dependency opentofu to v1.11.7 c14afde
* **deps:** update dependency opentofu to v1.12.0 ec94ec8
* **deps:** update dependency opentofu to v1.12.1 2d4e7a4
* **deps:** update dependency opentofu to v1.12.2 a4c9c63
* **deps:** update dependency opentofu to v1.12.3 cbf99d2
* **deps:** update dependency opentofu to v1.12.4 1633e86
* **deps:** update dependency terraform-docs to v0.23.0 469f1bf
* **deps:** update dependency terraform-docs to v0.24.0 afb7741
* **deps:** update dependency tflint to v0.62.1 3ac88d9
* **deps:** update dependency tflint to v0.63.1 2aaa148
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 2818935
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 36d8932
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 bebcc6e
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 cee85fc
* **pre-commit:** 🔧 move to prek a97dc8c
* **tfdocs:** bump tfdocs to v0.22 🔧 d9df363

## 8.1.4 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 6b224ea

### Code Refactoring

* update module structure and Github actions 👷 86e1f4c

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing cbcf3ce
* **deps:** update dependency trivy to v0.69.3 0718e5d
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 109cfad

## 8.1.3 (2026-03-02)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 b73af97

### Miscellaneous Chores

* **deps:** 🔗 bump tflint rules version 4ae6809
* **deps:** update dependency tflint to v0.61.0 33c157e
* **deps:** update dependency trivy to v0.69.1 585748f
* **deps:** update tools 91e676c
* merge remote-tracking branch 'origin/renovate/tools' 5d7c134
...
* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 6f299c3

### Miscellaneous Chores

* **⚙️:** ✏️ update template identifier for MR review 11e05cd
* 🗑️ remove old commitlint configuration files e7b7062
* **deps:** 🔗 bump AzureRM provider version to v4.31+ 3be5366
* **deps:** update dependency claranet/diagnostic-settings/azurerm to ~> 8.1.0 26c5263
* **deps:** update dependency opentofu to v1.10.0 409cf14
* **deps:** update dependency opentofu to v1.10.1 4822909
* **deps:** update dependency opentofu to v1.10.3 c8f5f87
* **deps:** update dependency opentofu to v1.10.6 17dc62b
* **deps:** update dependency tflint to v0.58.0 26b3e21
* **deps:** update dependency tflint to v0.58.1 d538302
* **deps:** update dependency tflint to v0.59.1 a4b495d
* **deps:** update dependency trivy to v0.63.0 c758554
* **deps:** update dependency trivy to v0.66.0 eede754
* **deps:** update dependency trivy to v0.67.0 d55f73c
* **deps:** update pre-commit hook pre-commit/pre-commit-hooks to v6 5959ff5
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.1 ae2d184
* **deps:** update terraform claranet/diagnostic-settings/azurerm to ~> 8.2.0 d7dbf39
* **deps:** update tools 0168039
* **deps:** update tools 6849011
* **deps:** update tools c7ad033
